...
![An infographic showing the relationships between AI, ML, and DL](fig/introduction/AI_ML_DL_differences.png)

The image above is based on a [similar image](https://commons.wikimedia.org/wiki/File:AI-ML-DL.svg) by [Tukijaaliwa](https://commons.wikimedia.org/wiki/User:Tukijaaliwa), [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.en)
...
![Summary of key concepts and sub-domains of ML](fig/introduction/ML_summary.png)
