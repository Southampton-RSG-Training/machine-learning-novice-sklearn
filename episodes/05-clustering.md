...
![Plot of the random clusters](fig/clustering/random_clusters.png)
...
![Plot of the fitted random clusters](fig/clustering/random_clusters_centre.png)
...
![An example of kmeans failing on non-linear cluster boundaries](fig/clustering/kmeans_concentric_circle.png)
...
![Kmeans attempting to classify overlapping clusters](fig/clustering/kmeans_overlapping_clusters.png)
...
![Spectral clustering on two concentric circles](fig/clustering/spectral_concentric_circle.png)
...
![Spectral clustering viewed with an extra dimension](fig/clustering/spectral_concentric_3d.png)
...
![Kmeans attempting to cluster the concentric circles](fig/clustering/kmeans_concentric_circle_2.png)

![Spectral clustering on the concentric circles](fig/clustering/spectral_concentric_circle_2.png)
