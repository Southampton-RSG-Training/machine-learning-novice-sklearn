...
![Example of linear and polynomial regressions](fig/regression/regression_example.png)
...
![Linear regression of dataset I](fig/regression/regress_linear.png)
...
![Linear regression of dataset II](fig/regression/regress_linear_2nd.png)
...
![Linear regression of dataset III](fig/regression/regress_linear_3rd.png)

![Linear regression of dataset IV](fig/regression/regress_linear_4th.png)
...
![Comparison of the regressions of our dataset](fig/regression/regress_both.png)
...
![Polynomial regression of dataset I](fig/regression/regress_polynomial_1st.png)

![Polynomial regression of dataset II](fig/regression/regress_polynomial_2nd.png)

![Polynomial regression of dataset III](fig/regression/regress_polynomial_3rd.png)

![Polynomial regression of dataset IV](fig/regression/regress_polynomial_4th.png)
...
![Polynomial regression of dataset I with N between 1 and 10](fig/regression/regress_polynomial_n_1st.png)

![Polynomial regression of dataset II with N between 1 and 10](fig/regression/regress_polynomial_n_2nd.png)

![Polynomial regression of dataset III with N between 1 and 10](fig/regression/regress_polynomial_n_3rd.png)

![Polynomial regression of dataset IV with N between 1 and 10](fig/regression/regress_polynomial_n_4th.png)
...
![Comparison of the regressions of our dataset](fig/regression/regress_penguin_lin.png)
...
![Comparison of the regressions of our dataset](fig/regression/regress_penguin_lin_tot.png)
