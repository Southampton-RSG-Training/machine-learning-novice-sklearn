...
![MNIST example illustrating all the classes in the dataset](fig/dimensionality-reduction/MnistExamples.png)
...
![MNIST example of a single image](fig/dimensionality-reduction/mnist_30000-letter.png)
...
![SKLearn image with highlighted pixels](fig/dimensionality-reduction/mnist_pairplot_pixels.png)
...
![SKLearn image with highlighted pixels](fig/dimensionality-reduction/mnist_pairplot.png)
...
```python
# We are passing None because it is an unlabelled plot
plots_labels(x_pca, None)
```

![Reduction using PCA](fig/dimensionality-reduction/pca_unlabelled.png)
...
![Reduction using PCA, with K-means clustering](fig/dimensionality-reduction/pca_clustered.png)
...
![Reduction using PCA, adding colour labelling](fig/dimensionality-reduction/pca_labelled.png)
...
![Reduction using PCA, applying t-SNE to the MNIST data](fig/dimensionality-reduction/tsne_unlabelled.png)
...
![Reduction using PCA, running K-means clustering on new 2D representation](fig/dimensionality-reduction/tsne_clustered.png)

![Reduction using PCA, adding in colour labelling](fig/dimensionality-reduction/tsne_labelled.png)
...
![Reduction to 3 components using pca](fig/dimensionality-reduction/pca_3d.svg)
...
![Reduction to 3 components using tsne](fig/dimensionality-reduction/tsne_3d.svg)
