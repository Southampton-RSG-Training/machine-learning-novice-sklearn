...
![*Artwork by @allison_horst*](fig/classification/palmer_penguins.png)

The physical attributes measured are flipper length, beak length, beak width, body mass, and sex.

![*Artwork by @allison_horst*](fig/classification/culmen_depth.png)
...
![Visualising the penguins dataset](fig/classification/e3_penguins_vis.png)
...
![Visualising the penguins dataset](fig/classification/pairplot.png)
...
![Decision tree for classifying penguins](fig/classification/decision_tree_example.png)
...
![Decision tree for classifying penguins](fig/classification/e3_dt_2.png)
...
![Classification space for our decision tree](fig/classification/e3_dt_space_2.png)
...
![Performance of decision trees of various depths](fig/classification/e3_dt_overfit.png)
...
![Simplified decision tree](fig/classification/e3_dt_6.png)
...
![Classification space of the simplified decision tree](fig/classification/e3_dt_space_6.png)
...
![Classification space generated by the SVM model](fig/classification/e3_svc_space.png)
